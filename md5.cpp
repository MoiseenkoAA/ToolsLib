 ...
 */
void MD5Init(MD5_CTX__ *mdContext)
{
 ...
 */
void MD5Update(MD5_CTX__ *mdContext, unsigned char *inBuf, unsigned int inLen)
{
    UINT4 in[16];
    int mdi;
    unsigned int i, ii;
 ...
 */
void MD5Final(unsigned char hash[], MD5_CTX__ *mdContext)
{
    UINT4 in[16];
    int mdi;
    unsigned int i, ii;
